...
| :--- | :--- | :--- |
| **Audio** | `.mp3`, `.wav`, `.aac`, `.flac`, `.ogg`, `.m4a` | Supports bitrate optimization and FLAC compression levels. |
| **Video** | `.mp4`, `.mkv`, `.mov`, `.avi`, `.webm` | Supports H.264 encoding and CRF optimization. |
